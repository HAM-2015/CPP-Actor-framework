...
public:
	...
	{
		Handler& h_ = _handler;
		_poster->try_tick([=]{h_((Arg1&)arg1, (Arg2&)arg2); });
	}
	...
	{
		Handler& h_ = _handler;
		_poster->try_tick([=]{h_((Arg1&)arg1, (Arg2&)arg2, (Arg3&)arg3); });
	}
	...
	{
		Handler& h_ = _handler;
		_poster->try_tick([=]{h_((Arg1&)arg1, (Arg2&)arg2, (Arg3&)arg3, (Arg4&)arg4); });
	}
	...
	{
			Handler& h_ = _handler;
			_poster->try_tick([=]{h_((Arg1&)arg1, (Arg2&)arg2, (Arg3&)arg3, (Arg4&)arg4, (Arg5&)arg5); });
		}

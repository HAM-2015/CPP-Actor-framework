...
public:
	...
	{
		_poster->next_tick(wrap_capture(_handler, arg1));
	}
	...
	{
		_poster->next_tick(wrap_capture(_handler, arg1, arg2));
	}
	...
	{
		_poster->next_tick(wrap_capture(_handler, arg1, arg2, arg3));
	}
	...
	{
		_poster->next_tick(wrap_capture(_handler, arg1, arg2, arg3, arg4));
	}
...
public:
	...
	{
		assert(!_checkOnce->exchange(true));
		_poster->next_tick(wrap_capture(std::move(_handler), FORCE_MOVE(arg1)));
	}
	...
	{
		assert(!_checkOnce->exchange(true));
		_poster->next_tick(wrap_capture(std::move(_handler), FORCE_MOVE(arg1), FORCE_MOVE(arg2)));
	}
	...
	{
		assert(!_checkOnce->exchange(true));
		_poster->next_tick(wrap_capture(std::move(_handler), FORCE_MOVE(arg1), FORCE_MOVE(arg2), FORCE_MOVE(arg3)));
	}
	...
	{
		assert(!_checkOnce->exchange(true));
		_poster->next_tick(wrap_capture(std::move(_handler), FORCE_MOVE(arg1), FORCE_MOVE(arg2), FORCE_MOVE(arg3), FORCE_MOVE(arg4)));
	}

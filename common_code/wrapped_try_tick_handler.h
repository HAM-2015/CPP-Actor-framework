...
public:
	...
	{
		_poster->try_tick(wrap_capture(_handler, TRY_MOVE(arg1)));
	}
	...
	{
		_poster->try_tick(wrap_capture(_handler, TRY_MOVE(arg1), TRY_MOVE(arg2)));
	}
	...
	{
		_poster->try_tick(wrap_capture(_handler, TRY_MOVE(arg1), TRY_MOVE(arg2), TRY_MOVE(arg3)));
	}
	...
	{
		_poster->try_tick(wrap_capture(_handler, TRY_MOVE(arg1), TRY_MOVE(arg2), TRY_MOVE(arg3), TRY_MOVE(arg4)));
	}
...
public:
	...
	void operator()()
	{
		...
		_poster->try_tick(FORCE_MOVE(_handler));
	}
	...
	{
		assert(!_checkOnce->exchange(true));
		_poster->try_tick(wrap_capture(FORCE_MOVE(_handler), FORCE_MOVE(arg1)));
	}
	...
	{
		assert(!_checkOnce->exchange(true));
		_poster->try_tick(wrap_capture(FORCE_MOVE(_handler), FORCE_MOVE(arg1), FORCE_MOVE(arg2)));
	}
	...
	{
		assert(!_checkOnce->exchange(true));
		_poster->try_tick(wrap_capture(FORCE_MOVE(_handler), FORCE_MOVE(arg1), FORCE_MOVE(arg2), FORCE_MOVE(arg3)));
	}
	...
	{
		assert(!_checkOnce->exchange(true));
		_poster->try_tick(wrap_capture(FORCE_MOVE(_handler), FORCE_MOVE(arg1), FORCE_MOVE(arg2), FORCE_MOVE(arg3), FORCE_MOVE(arg4)));
	}

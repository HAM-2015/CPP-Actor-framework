...
struct ActorGo_
{
	ActorGo_(const shared_strand& strand, size_t stackSize = DEFAULT_STACKSIZE);
	ActorGo_(shared_strand&& strand, size_t stackSize = DEFAULT_STACKSIZE);
	ActorGo_(io_engine& ios, size_t stackSize = DEFAULT_STACKSIZE);
